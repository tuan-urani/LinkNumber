...
class GameMenuPlayV3Button extends StatelessWidget {
  const GameMenuPlayV3Button({super.key, required this.onTap});
        ...
        child: Ink(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: <Color>[AppColors.color14B8A6, AppColors.color1C274C],
            ),
            borderRadius: 14.borderRadiusAll,
            border: Border.all(
            ...
            boxShadow: <BoxShadow>[
              BoxShadow(
                color: AppColors.color1A2D7DD2.withValues(alpha: 0.75),
